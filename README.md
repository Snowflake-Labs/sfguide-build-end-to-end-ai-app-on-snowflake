...
13. [Agent Observability](#agent-observability)
14. [MCP Server](#mcp-server)
15. [Optional: Iceberg V3 Features](#optional-iceberg-v3-features)
16. [Optional: Streaming Ingestion](#optional-streaming-ingestion)
17. [Cleanup](#cleanup)
